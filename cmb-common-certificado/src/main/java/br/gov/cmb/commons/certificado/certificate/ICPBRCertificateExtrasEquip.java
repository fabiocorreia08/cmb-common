...
import br.gov.cmb.commons.certificado.oid.OID_2_16_76_1_3_8;

/**
* Informacoes extras do Certificado (ICP-BRASIL - DOC-ICP-04 versao 5.3)<br>
* <br>
* Certificado Equipamentos<br>
* <br>
* OID:<br>
* 	* 2.16.76.1.3.2<br>
*   * 2.16.76.1.3.3<br>
...
*
*/
public class ICPBRCertificateExtrasEquip implements ResponsibleCertificateExtras {
	private ICPBRCertificateExtras extras = null;
	
	
	public ICPBRCertificateExtrasEquip(ICPBRCertificateExtras extras) {
		if (!extras.isCertificateEquipment()) {
			throw new CertificateExtrasWrongTypeException("Nao e certificado de equipamentos");
		}
	...
	private OID_2_16_76_1_3_8 getOID_2_16_76_1_3_8() {
		return (OID_2_16_76_1_3_8) extras.getOtherName(OID_2_16_76_1_3_8.OID);
	}
	...
	public String getNomeEmpresarial() {
		if (this.getOID_2_16_76_1_3_8() != null) {
			return this.getOID_2_16_76_1_3_8().getNome();
		}
		return null;
	}
}
