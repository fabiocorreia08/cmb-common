...
public class DocumentoRequestVO implements Serializable {
    ...
    public DocumentoRequestVO() {
    }
    
    public DocumentoRequestVO(String nomeTipoDocumento, Object parametros, String matricula) {
        this.nomeTipoDocumento = nomeTipoDocumento;
        this.parametros = JsonUtils.toJson(parametros);
